...
mod test {
    ...
    fn etag_lyric() {
        ...
        assert_eq!(
            lyric.etag().unwrap(),
            "\"62-14553646715080587640846522044641641457\""
        );
    }
    ...
    fn etag_lyric_post() {
        ...
        assert_eq!(
            ...
            "\"32-187184449774955225183439115370394895738\""
        );
    }
    ...
    fn etag_playlist() {
        ...
        assert_eq!(
            ...
            "\"59-184934709970697306187541097110251296538\""
        );
    }
    ...
    fn etag_playlist_post() {
        ...
        assert_eq!(
            ...
            "\"29-8504763498153674018128170645387736386\""
        );
    }
}
